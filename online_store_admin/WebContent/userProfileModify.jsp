...
<html lang="en">
<head>
<title>Aliespeed &mdash; Colorlib e-Commerce Template</title>
<meta charset="utf-8">
<meta name="viewport"
	...
	<div class="site-wrap">
			...
			<nav class="site-navigation text-right text-md-center"
				...
				<div class="container">
					<ul class="site-menu js-clone-nav d-none d-md-block">
						<li class="has-children active"><a href="index.jsp">Home</a>
						...
						<li class="has-children"><a href="about.jsp">About</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp">Profile</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Modify account</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Modify Profile</h2>
					</div>
					<div class="col-md-7">
						...
						<form action="userController.java" method="POST">
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Password </label> <input
											type="text" class="form-control" id="c_password"
											name="c_password">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Confirm
											Password </label> <input type="text" class="form-control"
											id="c_passwordConfirm" name="c_passwordConfirm">
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-lg-12">
										<input type="submit" class="btn btn-primary btn-lg btn-block"
											name="modifyButton" value="SendModification">
									</div>
								</div>
							</div>
						</form>
					...
					<div class="col-md-5 ml-auto">
						<div class="p-4 border mb-3">
							<span class="d-block text-primary h6 text-uppercase">Delete
								account</span>
							<p class="mb-0">This action will delete user account, be
								careful.</p>
							<form action="userControler.java" method="POST">
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Password</label> <input
											type="password" class="form-control" id="c_passwordDelete"
											name="c_passwordDelete">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Confirm
											...
											id="c_passwordDeleteConfirm" name="c_passwordDeleteConfirm">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
										<input type="submit" class="btn btn-primary btn-lg btn-block"
											name="modifyButton" value="DeleteAccount">
									</div>
								</div>
							</form>
						</div>
