...
<%@page language="java" import="model.User" import="java.util.List"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						...
						<strong class="text-black">Users List</strong>
					</div>
				</div>
			</div>
		</div>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td class="user-thumbnail"><img
											style="width: 100px; weight: 100px" class="img-fluid"
					...
					out.print(sb.toString());%>">
										...
										<td>
											<button class="btn btn-primary btn-sm"
												value="<%=newUser.getMail()%>" name="wButton">X</button>
										</td>
										<td>
											<button class="btn btn-primary btn-sm"
												value="<%=newUser.getMail()%>" name="mButton">O</button>
										</td>
