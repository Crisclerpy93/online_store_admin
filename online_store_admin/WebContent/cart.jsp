...
<%@page language="java" import="java.util.ArrayList" import ="com.sun.tools.javac.util.Pair" 
 import="onlineJavaCode.product" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="site-section">
      <div class="container">
       ...
       <form class="col-md-12" method="post">
          <% ArrayList<Pair<product,Integer>> cart=(ArrayList<Pair<product,Integer>> )session.getAttribute("cart");
          int counterId=0;%>
