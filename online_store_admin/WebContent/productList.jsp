...
<%@page language="java" import="model.Product" import="java.util.List"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="initPage.jsp">Admnistrator</a> <span class="mx-2 mb-0">/</span>
						<strong class="text-black">Products List</strong>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										%>
										<td class="product-thumbnail"><img class="img-fluid"
				...
				out.print(sb.toString());%>">
										...
										<td><input type="text" class="form-control text-center"
											value="<%=newProduct.getStock()%>" name=""
											id="<%=newProduct.getName()%>"></td>
										<td>
											<button class="btn btn-primary btn-sm"
												value="<%=newProduct.getId()%>" name="wButton">X</button>
										</td>
										<td>
											<button class="btn btn-primary btn-sm"
												value="<%=newProduct.getId()%>" name="mButton">O</button>
										</td>
