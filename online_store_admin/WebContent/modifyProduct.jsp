...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="initPage.jsp">Administrator</a> <span class="mx-2 mb-0">/</span> <a href="productList.jsp">Products List</a> <span class="mx-2 mb-0">/</span><strong class="text-black">Modify Product</strong></div>
        </div>
      </div>
    </div>
