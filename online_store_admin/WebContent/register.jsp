		...
		<header class="site-navbar" role="banner">
			...
			<nav class="site-navigation text-right text-md-center"
				...
				<div class="container">
					...
					<li class="has-children"><a href="index.html">Categories</a>
              			<ul class="dropdown">
	              			<li class="has-children"><a href="#">Menu One</a>
	                 			<ul class="dropdown">
	                		...
	                		<li class="has-children"><a href="#">Menu Three</a>
	                 		...
	                 		<li class="has-children"><a href="#">SubCategories</a>
	                  			<ul class="dropdown">
				                    <li><a href="#">Menu One</a></li>
				                    <li><a href="#">Menu Two</a></li>
				                    <li><a href="#">Menu Three</a></li>
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Register</strong>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-md-12">
						...
						<form action="userController.java" method="POST">
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">Are you a
											seller? <span class="text-danger"></span>
										</label> <input type="checkbox" id="c_seller" name="c_seller"
											value="Y"> Seller<br>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_subject" class="text-black">Repeat
