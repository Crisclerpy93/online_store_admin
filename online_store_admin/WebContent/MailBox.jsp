...
<%@page language="java" import="java.util.ArrayList"
	import="java.util.Iterator" import="javafx.util.Pair"%>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 mb-0">
					...
					<strong class="text-black">MailBox</strong>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row mb-5">
				<button type="button" class="btn btn-primary "
					style="margin-left: 15px; margin-bottom: 20px;" data-toggle="modal"
					data-target="#myModal">New message</button>
				<form class="col-md-12" action="/online_store_admin/admController"
					method="post">
					<%
						Pair<ArrayList<String>, ArrayList<String>> Mess = (Pair<ArrayList<String>, ArrayList<String>>) session
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									%>
									<td class="product-thumbnail"><%=Mess.getValue().get(ii)%>
									</td>
									...
									<td class="product-name">
										<button type="button" class="btn btn-primary"
											onclick=reply(this.id) id="<%=Mess.getValue().get(ii)%>"
